...
typedef enum {
  ...
  // Handover messages (after S11 --> MME_APP --> nas_cn  --> emm_sap --> AS!!
  EMMAS_HO_TAU_BEARER_MODIFICATION_CNF = _EMMAS_HO_TAU_BEARER_MODIFICATION_CNF,
  EMMAS_HO_TAU_BEARER_MODIFICATION_REJ = _EMMAS_HO_TAU_BEARER_MODIFICATION_REJ,
  // S1AP Handover Establishment
  EMMAS_S1AP_HO_ESTABLISHMENT_IND  = _EMMAS_S1AP_HO_ESTABLISHMENT_IND,
  ...
  EMMCN_UPDATE_LOCATION_RES           = _EMMCN_UPDATE_LOCATION_RES,
  EMMCN_UPDATE_LOCATION_FAIL          = _EMMCN_UPDATE_LOCATION_FAIL,
  ...
  /** Handover related messaged. */
  EMMCN_HO_BEARER_MODIFICATION_RES    = _EMMCN_HO_BEARER_MODIFICATION_RES,
  EMMCN_HO_BEARER_MODIFICATION_FAIL   = _EMMCN_HO_BEARER_MODIFICATION_FAIL,
  EMMCN_HO_FORWARD_RELOCATION_REQ     = _EMMCN_HO_FORWARD_RELOCATION_REQ,
