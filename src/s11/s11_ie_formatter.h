 ...
 *      * 1 = SGSN
 */
nw_rc_t gtpv2c_node_type_ie_get(uint8_t ieType, uint16_t ieLength, uint8_t ieInstance, uint8_t *ieValue, void *arg);

int gtpv2c_node_type_ie_set(nw_gtpv2c_msg_handle_t *msg, const node_type_t *node_type);
 ...
 *      * 3 = IPv4v6
 */
nw_rc_t gtpv2c_pdn_type_ie_get(uint8_t ieType, uint16_t ieLength, uint8_t ieInstance, uint8_t *ieValue, void *arg);

int gtpv2c_pdn_type_ie_set(nw_gtpv2c_msg_handle_t *msg, const pdn_type_t *pdn_type);
 ...
 */
nw_rc_t gtpv2c_rat_type_ie_get(uint8_t ieType, uint16_t ieLength, uint8_t ieInstance, uint8_t *ieValue, void *arg);
 ...
 * 3GPP TS 29.274 #8.18
 */
nw_rc_t gtpv2c_serving_network_ie_get(uint8_t ieType, uint16_t ieLength, uint8_t ieInstance, uint8_t *ieValue, void *arg);
 ...
 */
nw_rc_t gtpv2c_apn_ie_get(uint8_t ieType, uint16_t ieLength, uint8_t ieInstance, uint8_t *ieValue, void *arg);
...
nw_rc_t gtpv2c_uli_ie_get(uint8_t ieType, uint16_t ieLength, uint8_t ieInstance, uint8_t *ieValue, void *arg);
 ...
 * 3GPP TS 29.274 #8.27
 */
nw_rc_t gtpv2c_delay_value_ie_get(uint8_t ieType, uint16_t ieLength, uint8_t ieInstance, uint8_t *ieValue, void *arg);
int gtpv2c_delay_value_ie_set(nw_gtpv2c_msg_handle_t *msg, const DelayValue_t *delay_value);
 ...
 * 3GPP TS 29.274 #8.32
 */
nw_rc_t gtpv2c_bearer_flags_ie_get(uint8_t ieType, uint16_t ieLength, uint8_t ieInstance, uint8_t *ieValue, void *arg);
int gtpv2c_bearer_flags_ie_set(nw_gtpv2c_msg_handle_t *msg, const bearer_flags_t *bearer_flags);

/* Indication Element
 * 3GPP TS 29.274 #8.12
 */
nw_rc_t gtpv2c_indication_flags_ie_get(uint8_t ieType, uint16_t ieLength, uint8_t ieInstance, uint8_t *ieValue, void *arg);
int gtpv2c_indication_flags_ie_set (nw_gtpv2c_msg_handle_t * msg, const indication_flags_t * indication_flags);
...
nw_rc_t gtpv2c_fqcsid_ie_get(uint8_t ieType, uint16_t ieLength, uint8_t ieInstance, uint8_t *ieValue, void *arg);
