...
#include "../s10/s10_mme_session_manager.h"
...
#include "../s10/s10_common.h"
#include "../s10/s10_ie_formatter.h"
  ...
  nw_gtpv2c_ulp_api_t * pUlpApi)
{
  ...
  resp_p->trxn = (void *)pUlpApi->u_api_info.triggeredRspIndInfo.hUlpTrxnId;
